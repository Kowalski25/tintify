...
const aboutContent: AboutContentProps = {
  ...
  section3: {
    ...
    items: [
      ...
      "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Necessitatibus voluptatem cupiditate voluptas.",
